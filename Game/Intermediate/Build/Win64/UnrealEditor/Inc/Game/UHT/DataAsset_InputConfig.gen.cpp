...
#include "Game/Public/DataAssets/Input/DataAsset_InputConfig.h"
...
GAME_API UClass* Z_Construct_UClass_UDataAsset_InputConfig();
GAME_API UClass* Z_Construct_UClass_UDataAsset_InputConfig_NoRegister();
GAME_API UScriptStruct* Z_Construct_UScriptStruct_FWarriorInputActionConfig();
...
class UScriptStruct* FWarriorInputActionConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WarriorInputActionConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWarriorInputActionConfig, (UObject*)Z_Construct_UPackage__Script_Game(), TEXT("WarriorInputActionConfig"));
	}
	return Z_Registration_Info_UScriptStruct_WarriorInputActionConfig.OuterSingleton;
}
template<> GAME_API UScriptStruct* StaticStruct<FWarriorInputActionConfig>()
{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDataAsset_InputConfig_Statics::NewProp_NativeInputActions_Inner = { "NativeInputActions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FWarriorInputActionConfig, METADATA_PARAMS(0, nullptr) }; // 568016304
...
template<> GAME_API UClass* StaticClass<UDataAsset_InputConfig>()
{
	return UDataAsset_InputConfig::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWarriorInputActionConfig::StaticStruct, Z_Construct_UScriptStruct_FWarriorInputActionConfig_Statics::NewStructOps, TEXT("WarriorInputActionConfig"), &Z_Registration_Info_UScriptStruct_WarriorInputActionConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWarriorInputActionConfig), 568016304U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDataAsset_InputConfig, UDataAsset_InputConfig::StaticClass, TEXT("UDataAsset_InputConfig"), &Z_Registration_Info_UClass_UDataAsset_InputConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataAsset_InputConfig), 4218595310U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_1231266550(TEXT("/Script/Game"),
	Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_DataAssets_Input_DataAsset_InputConfig_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
