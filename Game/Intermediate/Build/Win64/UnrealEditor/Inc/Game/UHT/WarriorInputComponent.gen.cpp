...
#include "Game/Public/Components/Input/WarriorInputComponent.h"
...
GAME_API UClass* Z_Construct_UClass_UWarriorInputComponent();
GAME_API UClass* Z_Construct_UClass_UWarriorInputComponent_NoRegister();
...
template<> GAME_API UClass* StaticClass<UWarriorInputComponent>()
{
	return UWarriorInputComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_Components_Input_WarriorInputComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWarriorInputComponent, UWarriorInputComponent::StaticClass, TEXT("UWarriorInputComponent"), &Z_Registration_Info_UClass_UWarriorInputComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWarriorInputComponent), 1151597081U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_Components_Input_WarriorInputComponent_h_1417861033(TEXT("/Script/Game"),
	Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_Components_Input_WarriorInputComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ZeroDeadlySins_Game_Source_Game_Public_Components_Input_WarriorInputComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
